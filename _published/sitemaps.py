...
def items():
    items = [
        dict(
            location='/ipython-notebooks/html-reports',
            lmfile=os.path.join(
                settings.TOP_DIR,
                'shelly',
                'templates',
        ...
        dict(
            location='/ipython-notebooks/cron-jobs',
            lmfile=os.path.join(
                settings.TOP_DIR,
                'shelly',
                'templates',
        ...
        dict(
            location='/ipython-notebooks/pandas-primer',
            lmfile=os.path.join(
                settings.TOP_DIR,
                'shelly',
                'templates',
        ...
        dict(
            location='/ipython-notebooks/color-lover',
            lmfile=os.path.join(
                settings.TOP_DIR,
                'shelly',
                'templates',
